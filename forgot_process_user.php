...
$headers  = "MIME-Version: 1.0\n";
     ...
     $msg="Your password reset link <br> http://localhost:8081/php/form/password-reset_user.php?token=".$token." <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>".$credits."</center>"; 
   if(@mail($oldftemail, $subject, $msg, $headers,'-f'.$FromEmail) ){
header("location:forgot-password_user.php?sent=1"); 
$hide='1';
          
    } else {
        
    header("location:forgot-password_user.php?servererr=1"); 
} 
      } 
      else 
      { 
          header("location:forgot-password_user.php?something_wrong=1"); 
      }     
}
else  
{
header("location:forgot-password_user.php?err=".$login); 
}
}
?>