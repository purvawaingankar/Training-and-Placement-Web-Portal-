...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
      <img src="NHITM_logo.png" alt="NHITM" class="logo img-fluid"> 
    </div>
     <div class="col-sm-4">
    </div>
  </div>
...
?>
    ...
    <a href="login_user.php" style="color:black;">Login here... </a> </div>
      <?php } else { ?>
        <h3> Candidate's Sigup </h3><br>
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</button>
   <p>Have an account?  <a href="login_user.php">Log in</a> </p>
</form>
<?php } ?> 
</div>
		</div>
