...
<div class="container">
  ...
  <p> Welcome! <span style="color:#33CC00"><?php echo $username; ?></span> </p>
            ...
            <div class="col"><p><a href="logout_user.php"><span style="color:red;">Logout</span> </a></p>
         </div>
          </div>
          ...
          <tr>
           ...
           <div class="row">
            <div class="col-sm-2">
             ...
             <div class="col-sm-4">
                <a href="edit-profile_user.php"><button type="button" class="btn btn-primary">Edit Profile</button></a>
            </div>
            <div class="col-sm-6">
         <a href="change-password_user.php"><button type="button" class="btn btn-warning">Change Password</button></a>
            </div>
